...
# Add a .py file
# Create a simple version of an agent based simulation, based on the code in 
# the last lecture, and the github repo linked at the end
from numpy import random, mean

params = {'world_size':(4,4),
          'num_agents':4,
          'same_pref' :0.4,
          'max_iter'  :100,
          'out_path'  :r'/Users/sarahmorrison/Downloads/GitHub/week-9-lab-b/abm_results.csv' }
...
class World():
    ...
    def init_world(self):
         ...
         assert(sum([occupant is not None for occupant in 
                     self.grid.values()]) == self.params['num_agents']),'Mismatch between number of agents and number of locations with agents.'
